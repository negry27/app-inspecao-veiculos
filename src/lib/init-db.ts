...
// Credenciais do Master (Atualizadas para admin/admin)
const MASTER_CONFIG = {
    email: "admin", // Usando 'admin' como email para consistência
    password: "admin", // Senha TEMPORÁRIA
    name: "admin", // Nome de usuário
};
